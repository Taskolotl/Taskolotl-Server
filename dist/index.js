...
const midnightTask = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield addEntry(CurrentDateRetriever_1.CurrentDateRetriever.getCurrentDate(), "Faith", "Don't read scans you didn't pay for", false);
    ...
    yield addEntry(CurrentDateRetriever_1.CurrentDateRetriever.getCurrentDate(), "Housework", "Do a load of laundry if there's enough", false);
    ...
    yield addEntry(CurrentDateRetriever_1.CurrentDateRetriever.getCurrentDate(), "Work", "5 hours of concentrated work", false);
});
